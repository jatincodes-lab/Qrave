...
internal static class SqlProblemMapper
{
    ...
    private static IResult ToDomainProblem(int errorNumber)
    {
        return errorNumber switch
        {
            ...
            51710 => Conflict("Closed orders cannot be changed."),
            51711 => ApiProblemResponses.BadRequest("Cancellation quantity is invalid."),
            51712 => ApiProblemResponses.BadRequest("Cancellation reason is required and must be 300 characters or fewer."),
            51713 => ApiProblemResponses.NotFound("Order item was not found for this order."),
            51714 => Conflict("Items cannot be cancelled after payment has started."),
            51715 => Conflict("This item cancellation request was already handled."),
            51716 => ApiProblemResponses.Forbidden("This order can only be changed from the device used to place it."),
            51717 => Conflict("Item cancellation can no longer be requested for this order. Please contact staff."),
            51718 => ApiProblemResponses.NotFound("Item cancellation request was not found."),
            51719 => ApiProblemResponses.BadRequest("Cancellation request decision is invalid."),
            ...
            52002 => ApiProblemResponses.Locked("This restaurant is temporarily unavailable."),
            52101 => ApiProblemResponses.BadRequest("Promo code is invalid or not eligible for this order."),
            52102 => Conflict("This offer has reached its usage limit."),
            52103 => Conflict("This promo code has already been used by this customer."),
